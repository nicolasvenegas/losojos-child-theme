...
<style>
  ...
  #los-ojos-canvas {
   ...
   #los-ojos-logo {
    ...
    top: 50%;
    left: 50%;
    /* translate3d activa la aceleración por hardware de la GPU del móvil, eliminando bordes dentados */
    transform: translate3d(-50%, -50%, 0); 
    width: min(25vw, 300px);
    height: auto; /* CRUCIAL: mantiene la proporción original del SVG */
    max-height: 300px; /* Seguridad para que no crezca de más */
    pointer-events: none;
    user-select: none;
    
    /* Forzar renderizado de alta calidad en navegadores móviles */
    image-rendering: -webkit-optimize-contrast;
    shape-rendering: geometricPrecision;
    -webkit-backface-visibility: hidden; /* Evita parpadeos y mejora el anti-aliasing en iOS */
    backface-visibility: hidden;
    transition: opacity 0.6s ease;
  }
  #los-ojos-logo { transition: opacity 0.6s ease; }
...
<main id="primary" class="site-main los-ojos-hero">
    ...
    <div class="screen-reader-text">
        <h1>Los Ojos</h1>
        <h2>Investigación y desarrollo de proyectos de cine expandido, videomapping, realidad aumentada y diseño interactivo en Temuco, Sur de Chile.</h2>
        <p>Los Ojos es un estudio independiente dedicado a la tecnocreatividad, fusionando programación creativa y diseño para crear experiencias inmersivas.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  for (let i = 0; i < N; i++) {
    ...
    const b = Bodies.circle(x, y, r, {
      restitution: 0.15, friction: 0.15, frictionAir: 0.01,
    });
  ...
  requestAnimationFrame(() => requestAnimationFrame(updateLogoBody));
