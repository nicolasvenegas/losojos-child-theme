...
<main id="primary" class="site-main taxonomy-tema">

    <div class="wp-block-group alignwide">

        <header class="taxonomy-tema-header">

            <p class="taxonomy-tema-label">
                Tema
            </p>

            <h1 class="taxonomy-tema-title">
                <?php echo esc_html($term->name); ?>
            </h1>

            <?php if (!empty($term->description)) : ?>

                <div class="taxonomy-tema-description">
                                        ...
                                        <a
                                            href="<?php echo esc_url(
                                                add_query_arg(
                                                    'tipo-de-proyecto',
                                                    $term_type->slug,
                                                    get_permalink(get_page_by_path('laboratorio'))
                                                )
                                            ); ?>"
                                        >
